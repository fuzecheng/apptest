...
//    WebDriverWait wait;
//
//    public OperateElement(AndroidDriver driver) {
//        this.driver = driver;
...
//                break;
//            case NAME:
//                by = By.xpath("//android.widget.TextView[@text='"+element_info+"']");
//                break;
//            case XPATH:
...
//                break;
//            case CLASSNAME:
//                by= By.className(element_info);
//                break;
//            case DESC:
//                by=By.xpath("//view[contains(@content-desc,\""+element_info+"\")]");
//                break;
//            default:
...
//                }
//                case "swip":{
//                    if (testCase.getSwipe_type().trim().equals("up")){
//                        driver.swipeUp();
//                    }else if (testCase.getSwipe_type().trim().equals("down")){
//                        driver.swipeDown();
//                    }else if(testCase.getSwipe_type().trim().equals("left")){
//                        driver.swipeLeft();
//                    }else if (testCase.getSwipe_type().trim().equals("right")){
//                        driver.swipeRight();
//                    }
//                    break;
//                }
//                case "longclick":{
//                    new TouchAction(driver).longPress(webElement).waitAction(Duration.ofSeconds(3)).perform();
//                }
//                default:
